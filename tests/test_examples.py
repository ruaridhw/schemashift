...
class TestCamstarLotMovement:
    ...
    def config(self) -> FormatConfig:
        ...
        return FormatConfig.model_validate(json.loads(path.read_text()))
    ...
    def test_config_loads_and_validates(self, config: FormatConfig) -> None:
...
class TestFabxLotMovement:
    ...
    def test_config_loads(self, config: FormatConfig) -> None:
...
class TestAutoDetection:
    ...
    def registry(self) -> DictRegistry:
        ...
        r.register(FormatConfig.model_validate(json.loads(camstar_path.read_text())))
        r.register(FormatConfig.model_validate(json.loads(fabx_path.read_text())))
        return r
